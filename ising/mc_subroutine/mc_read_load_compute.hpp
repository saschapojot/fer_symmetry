...
{
public: mc_computation(const std::string& cppInParamsFileName): e2(std::random_device{}()), ind_int_0_1(0, 1),distUnif01(0.0, 1.0)
{
...
public:
    ...
    std::uniform_int_distribution<int> ind_int_0_1;
    int sweep_multiple;
