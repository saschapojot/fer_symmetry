...
N=65#unit cell number
startingFileIndSuggest=8
init_path=0
which_row=0
chunk_size = 12
T_vec1=[10+n*0.2 for n in range(0,6)]
T_vec2=[11.3 + n*0.01 for n in range(1,10)]
...
def contents_to_bash(chk_ind,T_ind,chunks):
    ...
    contents=[
        ...
        f"#SBATCH -e out_exec_checking_s_{TStr}.err\n",
        "cd /public/home/hkust_jwliu_1/liuxi/Document/cppCode/fer_symmetry/ising\n",
