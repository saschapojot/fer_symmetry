...
def magetization_one_T(oneTFile):
    ...
    chi_val_each_site=(E_M2-E_M**2)*beta
    chi_val_total=chi_val_each_site*N**2
    # beta=1/T_value
    #compute dbeta chi1
    # E_H0=np.mean(df_U)
    ...
    return np.abs(magnetization),chi_val_total,chi_val_each_site,
...
for k in range(0,len(sortedTFiles)):
    ...
    s_abs,chi_val_total,chi_val_each_site=magetization_one_T(oneTFile)
