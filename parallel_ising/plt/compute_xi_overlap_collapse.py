...
#the interpolation is in overlapping region
...
def load_data_one_N(N):
    ...
    print(f"T_2_collapse={T_2_collapse}")
...
def diff_1_val(ind_NA,ind_NB,d,c):
    ...
    # print("=======================")
    # print("\n")
    # print(f"chi_vec_for_A={chi_vec_for_A}")
    # print("=======================")
    # print("\n")

    #collapsed chi for interpolation
    chi_collapsed_vec_for_A=chi_vec_for_A/NA**d
    # print(f"chi_collapsed_vec_for_A={chi_collapsed_vec_for_A}")
    # print("=======================")
    # print("\n")
    ...
    # print(f"t_vec_A={t_vec_A}")
    # print("=======================")
    # print("\n")


    t_vec_collapsed_for_A=t_vec_A/NA**c
    # print(f"t_vec_collapsed_for_A={t_vec_collapsed_for_A}")
    # print("=======================")
    # print("\n")
    ...
    for ind,val in enumerate(t_vec_collapsed_for_A):
        if val>=t_B_collapse_min and val<=t_B_collapse_max:
            ...
            chi_A_collapse_overlap_vec.append(chi_collapsed_vec_for_A[ind])

    # print(f"t_A_collapse_overlap_vec={t_A_collapse_overlap_vec}")
    # print("=======================")
    # print("\n")
    # print(f"chi_A_collapse_overlap_vec={chi_A_collapse_overlap_vec}")
    # print("=======================")
    # print("\n")
    t_A_overlap_vec_interp=np.array(t_A_collapse_overlap_vec)
    chi_A_collapse_overlap_vec_interp=np.array(chi_A_collapse_overlap_vec)


    func_A=PchipInterpolator(t_A_overlap_vec_interp,chi_A_collapse_overlap_vec_interp)
    #for comparison
    ...
    # print(f"t_B_collapse_overlap_vec={t_B_collapse_overlap_vec}")
    # print("=======================")
    # print("\n")
    # print(f"chi_B_original_overlap_vec={chi_B_original_overlap_vec}")
    # print("=======================")
    # print("\n")
    ...
    # print(f"func_A_vals_on_B={func_A_vals_on_B}")
    # print("=======================")
    # print("\n")
    # print(f"func_A_vals_on_B*NB**d={func_A_vals_on_B*NB**d}")
    # print("=======================")
    # print("\n")
